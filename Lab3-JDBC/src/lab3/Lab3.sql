DROP TABLE DEPT0753 CASCADE CONSTRAINTS;
DROP TABLE EMP0753 CASCADE CONSTRAINTS;

CREATE TABLE DEPT0753 (
...
CREATE TABLE EMP0753 (
	...
	SAL NUMBER(7,2),
	COMM NUMBER(7,2),
	DEPTNO NUMBER(2) REFERENCES DEPT0753(DEPTNO)
);

INSERT INTO DEPT0753 VALUES
...
INSERT INTO EMP0753 VALUES
	(7566,'JONES','ANALYST(M)',to_date('2-4-1981','dd-mm-yyyy'),2975,NULL,20);
INSERT INTO EMP0753 VALUES
	(7654,'MARTIN','SALESMAN',to_date('28-9-1981','dd-mm-yyyy'),1250,1400,30);
INSERT INTO EMP0753 VALUES
	(7698,'BLAKE','SALESMAN(M)',to_date('1-5-1981','dd-mm-yyyy'),2850,NULL,30);
INSERT INTO EMP0753 VALUES
...
INSERT INTO EMP0753 VALUES
	(7839,'KING','CONSULTANT(M)',to_date('17-11-1981','dd-mm-yyyy'),5000,NULL,10);
INSERT INTO EMP0753 VALUES
...
ALTER TABLE DEPT0753 ADD CONSTRAINT FK_DEPT0753
	FOREIGN KEY(MANAGER) REFERENCES EMP0753(EMPNO);
